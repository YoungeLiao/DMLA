...
def set_config(DATA_NAME, config, n_clusters = 7, thre = 0.38, num_epoch = 20000):
    ...
    # config['args_result_pat、、h'] = config['ROOT_RESULTS_PATH'] + NEWDATA_FOLDER
...
if torch.cuda.is_available():
    ...
    getEdges_cuda(config) # Edge data will be generated. to do: use 'if' to choose whether generate data
else:
