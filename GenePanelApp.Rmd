...
E(igraph)$color <- 'green'

plot(igraph, 
     vertex.color = 'gray', edge.color = E(igraph)$color,
...
# 也可能与nodes、list无关，只要是expression top3即可？
...
### Visualization & obtain landmark genes (TO DO)
